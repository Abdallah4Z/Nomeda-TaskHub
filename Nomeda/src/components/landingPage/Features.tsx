  ...
  return (
    <Container id="features" sx={{py: {xs: 8, sm: 16}}}>
      <Box sx={{width: {sm: '100%', md: '60%'}}}>
        ...
        >
          A Task Management Dashboard empowers teams with organized workflows
          and real-time insights, while an integrated Chatbot enhances
          productivity by enabling seamless task management through natural
